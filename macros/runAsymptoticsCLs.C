...
The results will be printed as well as stored in a root file in the folder 'root_files/<folder>', where <folder>
...
//bool doBlind               = 0;             // in case your analysis is unblinded
