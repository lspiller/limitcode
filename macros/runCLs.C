...
//do asimov
  ...
  fileName << "root_files/" << folder << "/" << smass << ".root";
  ...
  fileName3 << "root_files/" << folder + "_clsb" << "/" << smass << ".root";
  system(("mkdir -vp root_files/" + folder + "_clsb").c_str());
  ...
  fileName4 << "root_files/" << folder + "_clb" << "/" << smass << ".root";
  system(("mkdir -vp root_files/" + folder + "_clb").c_str());
