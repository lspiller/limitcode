...
void saveAscii(string folder)
{
  ...
  set<double> massPoints;
	massPoints.insert(100);
	massPoints.insert(105);
	massPoints.insert(110);
	massPoints.insert(115);
	massPoints.insert(120);
	massPoints.insert(125);
	massPoints.insert(130);
	massPoints.insert(135);
	massPoints.insert(140);
	massPoints.insert(145);
	massPoints.insert(150);
