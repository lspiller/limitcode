...
void getRates(string sampleName, string folder, double mass, bool alt)
{
  ...
  float l0pt, l1pt, mll, mtt, mt, metrel, trackmet, ptll, ptlljets, dphi, dphillmet, frecoil, pttot, /*bdphi, bdpsi,*/ met, dYjj, Mjj, cjv_leadPt, metstvf, metrelstvf, BDT_1jet_4vars, smt_muon_pt, isSS;

  unsigned int urun;
  int nj, ne, nm, run, nbt25, nbt20, islowpt, isBlinded, ztautaumass, olv;
